...
const dumpflag = [
  { text: 'add-locks', value:'add-locks'},
  { text: 'ignore-error', value: 'ASMLib'},
  { text: 'max-allowed-packet', value: 'max-allowed-packet'}
]


const migrationJobType = [
  { text: 'One-time', value:'One-time'},
  { text: 'Continous', value: 'Continous'}
]

const connectionMethod = [
  { text: 'Source and Destination are using Private IP', value:'Source and Destination are using Private IP'},
  { text: 'IP Allowlist', value: 'IP Allowlist'}
]
...
export {localDataStorageParamters, errorInfo, dataMountPurposeOptions, BaseOptions, redundancyOptions, asmDiskOptionSelect, auSizeOptions, dumpflag, migrationJobType,connectionMethod}
